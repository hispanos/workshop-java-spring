package com.workshop.workshopmaven.validator.model;

public class XlsxRequestModelValidator {
    ...
    private Integer incidentCost;
    private String wkDay;
    private Integer month;
    private Integer year;

    public XlsxRequestModelValidator() {
    }
    ...
    public Integer getIncidentCost() {
        return incidentCost;
    }

    public void setIncidentCost(Integer incidentCost) {
